...
(rnf2r_fileset<-countFileset(new("fileset", filename=c("../hESC/H1_INPUTplus_P038_Index8_S19.R1_trimmed.fastq.bam",
...
labels=c("INPUT_PLUS","INPUT_MINUS","BCOR_PLUS","BCOR_MINUS","KDM2B_PLUS","KDM2B_MINUS"))))
...
```{r figure4d}
head(degs.k2bKO_up)
length(kd2b_only<-tss_classified[tss_classified$class=="strong" & tss_classified$deg_k2bKO=="UP" & tss_classified$deg_bcor!="UP"])
length(bcor_only<-tss_classified[tss_classified$class=="strong" & tss_classified$deg_k2bKO!="UP" & tss_classified$deg_bcor=="UP"])



tss_classified$kd2b_v_bcor<-ifelse(tss_classified$deg_k2bKO=="UP" & tss_classified$deg_bcor!="UP","k2b_only",
                            ifelse(tss_classified$deg_k2bKO!="UP" & tss_classified$deg_bcor=="UP","bcor_only",
                            ifelse(tss_classified$deg_k2bKO=="UP" & tss_classified$deg_bcor=="UP","k2b_bcor","not_up")))
table(tss_classified[tss_classified$class=="strong"]$kd2b_v_bcor)
