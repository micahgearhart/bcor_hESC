...
length(random<-sample(tss_classified[tss_classified$class=="strong"],200))
...
length(bcor_genes<-bcor_genes[bcor_genes %in% tss_classified$ensembl[tss_classified$class=="strong"]])
length(rab_genes<-rab_genes[rab_genes %in% tss_classified$ensembl[tss_classified$class=="strong"]])
length(kdm2b_genes<-kdm2b_genes[kdm2b_genes %in% tss_classified$ensembl[tss_classified$class=="strong"]])
