...
write.csv(mcols(tss_classified),file="chip_enrichment_and_fpkm_data_101017.csv",quote=F,row.names = F)
```
...
temp<-log2(f_diff+0.1)
temp<-cbind(temp[,2:7]-temp[,1],temp[,9:14]-temp[,8],temp[,16:17]-temp[,15])

table(f_diff$bcor_deg<-ifelse(temp$bcor_1 > 1 | temp$bcor_2 > 1 | temp$bcor_3 > 1 | temp$bcor_4 > 1 | temp$bcor_5 > 1 | temp$bcor_6 > 1,"UP",
                             ifelse(temp$bcor_1 < -1 | temp$bcor_2 < -1 | temp$bcor_3 < -1 | temp$bcor_4 < -1 | temp$bcor_5 < -1 | temp$bcor_6 < -1 , "DN","NR")))

table(f_diff$rab_deg<-ifelse(temp$r1b_1 > 1 | temp$r1b_2 > 1 | temp$r1b_3 > 1 | temp$r1b_4 > 1 | temp$r1b_5 > 1 | temp$r1b_6 > 1,"UP",
                             ifelse(temp$r1b_1 < -1 | temp$r1b_2 < -1 | temp$r1b_3 < -1 | temp$r1b_4 < -1 | temp$r1b_5 < -1 | temp$r1b_6 < -1, "DN","NR")))

table(f_diff$k2b_deg<-ifelse(temp$kdm2b1 > 1 | temp$kdm2b2 > 1,"UP",
                             ifelse(temp$kdm2b1 < -1 | temp$kdm2b2 < -1, "DN","NR")))
